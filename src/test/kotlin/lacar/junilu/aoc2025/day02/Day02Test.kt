...
class Day02Test {
    ...
    fun `Github input solution - Parts 1 & 2`() {
        val puzzle = Day02.using(readPuzzleInput("aoc2025/day02-gh").first())
    ...
    fun `GMail input solution - Parts 1 & 2`() {
        val puzzle = Day02.using(readPuzzleInput("aoc2025/day02-gm").first())
    ...
    @Test
    fun `Example input`() {
        val puzzle = Day02.using(example)
