...
class Day11Test {
    ...
    companion object {
        val puzzleUsingGitHubInput = Day11.using(readPuzzleLines("aoc2024/day11-gh").first())
        val puzzleUsingGmailInput = Day11.using(readPuzzleLines("aoc2024/day11-gm").first())
    }
}